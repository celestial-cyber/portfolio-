  ...
  return (
    <section id="home" className="relative min-h-screen w-full overflow-hidden">
      <div className="container relative flex min-h-screen flex-col items-center px-4 pt-0 md:px-6">
        {/* Saturn Animation - Positioned higher */}
        <motion.div
        ...
        {/* Content container - Moved closer to Saturn */}
        <div className="relative z-20 flex flex-col items-center mt-[-280px]">
          ...
          <motion.p
            ...
            className="mb-8 max-w-2xl text-center text-xl italic text-white"
            style={{
